...
class ViewRecipe extends View {
  ...
  _error404 = `We could not find the recipe. Please try another one!`;
  _success = `Success!`;
  ...
  addHandlerUpdateServing(handler) {
    this._parentElement.addEventListener('click', function (e) {
      ...
      const updateTo = +btn.dataset.serve;
...
<div class="recipe__details">
  <div class="recipe__info">
    <svg class="recipe__info-icon">
      <use href="${iconsSvg}#icon-clock"></use>
    </svg>
  ...
  <div class="recipe__info">
    <svg class="recipe__info-icon">
      <use href="${iconsSvg}#icon-users"></use>
    </svg>
    ...
    <div class="recipe__info-buttons">
      <button
        ...
        data-serve="${this._data.servings - 1}"
      >
        <svg>
          <use href="${iconsSvg}#icon-minus-circle"></use>
        </svg>
      </button>
      <button
        class="btn--tiny btn--update-servings"
      ...
      >
        <svg>
          <use href="${iconsSvg}#icon-plus-circle"></use>
        </svg>
      </button>
    </div>
  </div>
...
<div class="recipe__ingredients">
  ...
  <ul class="recipe__ingredient-list">
    ${this._generateIngridients(this._data.ingredients).join('')}
  </ul>
</div>
        ...
        `
          <li class="recipe__ingredient">
            <svg class="recipe__icon">
              <use href="${iconsSvg}#icon-check"></use>
            </svg>
